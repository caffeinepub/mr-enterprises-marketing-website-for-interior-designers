...
export function ContactCtaSection() {
  ...
  const whatsappUrl = buildWhatsAppUrl('Hello Sahil,\nVisited your portfolio and wanted to know a little more about MR Enterprises.');
    ...
    <section id="contact" className="py-20 bg-background">
      <div className="w-full px-6 md:container md:mx-auto md:px-4">
        <div className="content-wrapper-mobile text-center mb-12">
          ...
          <p 
            data-testid="contact-cta-tagline"
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
          ...
          <Button size="lg" variant="outline" asChild className="w-full sm:w-auto border-primary text-primary hover:bg-primary hover:text-primary-foreground">
